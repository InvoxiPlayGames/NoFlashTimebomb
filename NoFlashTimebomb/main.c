...
*/
BYTE timebombSearchByte[] = { 0x66, 0x0f, 0x2f, 0x05, 0x00, 0x00, 0x00, 0x00, 0x48, 0x8b, 0xcb, 0x0f, 0x93, 0xc0 };
BYTE timebombSearchMask[] = { 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff };

BYTE timebombReplacByte[] = { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x00, 0x00, 0x00, 0x90, 0xb0, 0x00 };
BYTE timebombReplacMask[] = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff };
#else // i386
/*
...
__declspec(dllexport) int PatchFlashTimebombHandle(HMODULE hModule)
{
	...
	if (lpFoundAddress != NULL)
	{
		...
		FlushInstructionCache(GetCurrentProcess(), lpPatchBytes, sizeof(timebombReplacByte));
